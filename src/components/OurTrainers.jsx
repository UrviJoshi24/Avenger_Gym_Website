  ...
  return (
    <div className='d-flex flex-cloumn w-100 mh-100' id={scrollspyHeading2} style={{}}>
      <div data-aos="zoom-out" className='w-25 d-flex flex-column justify-content-center'>
        ...
        <span><i><h4 className='text-center fw-bold py-3 px-4 bg-white'>At our gym, we pride ourselves on having a team of highly skilled and passionate trainers dedicated to helping you achieve your fitness goals.</h4></i></span>
      </div>
